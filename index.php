<?php
// gunakan config + head (head.php harus berisi DOCTYPE..head..body buka)
include __DIR__ . '/config/config.php';
include __DIR__ . '/includes/head.php';        // DOCTYPE + <head> + buka <body>
                            ...
                            <div class="page-block">
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?= BASE_URL ?>/index.php"><i class="feather icon-home"></i></a></li>
